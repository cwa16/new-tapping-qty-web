            ...
            <table class="w-full table-auto border-collapse">
                <thead>
                    <tr class="bg-blue-500 text-white">
                        ...
                        <th style="width: 12%" class="px-2 py-1 font-normal">Tanggal Inspeksi</th>
                        <th class="px-2 py-1 font-normal">Dept</th>
                        <th class="px-2 py-1 font-normal">Kemandoran</th>
                        <th class="px-2 py-1 font-normal">Nama Penyadap</th>
                        <th class="px-2 py-1 font-normal">Panel Sadap</th>
                ...
                <tbody>
                    ...
                    <tr class="{{ $loop->iteration % 2 == 0 ? 'bg-gray-100' : 'bg-white' }}">
                        <td class="px-2 py-0.5 border border-gray-300 text-center">{{ $loop->iteration }}</td>
                        <td class="px-2 py-0.5 border border-gray-300">{{ \Carbon\Carbon::parse($item->tgl_inspeksi)->format('d M Y') }}</td>
                        <td class="px-2 py-0.5 border border-gray-300 text-center">{{ $item->dept }}</td>
                        <td class="px-2 py-0.5 border border-gray-300">{{ $item->kemandoran }}</td>
                        <td class="px-2 py-0.5 border border-gray-300">{{ $item->nama_penyadap }}</td>
                        <td class="px-2 py-0.5 border border-gray-300">{{ $item->panel_sadap }}</td>
                        <td class="px-2 py-0.5 border border-gray-300 text-center">{{ $item->nilai }}</td>
