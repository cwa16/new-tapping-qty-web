            ...
            <form method="GET" action="{{ route('assessment-details.index') }}">
                <div class="grid grid-cols-6 items-center gap-x-2">
                    ...
                    <div class="">
                        ...
                        <select name="dept"
                            class="px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 w-full">
                            <option value="">All Sub Division</option>
                            @foreach ($departments as $item)
                                <option value="{{ $item->dept }}"
                                    {{ ($filters['dept'] ?? '') == $item->dept ? 'selected' : '' }}>
                                    {{ $item->dept }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="">
                        ...
                        <select name="kemandoran"
                            ...
                            @foreach ($kemandoran as $item)
                                <option value="{{ $item->kemandoran }}"
                                    {{ ($filters['kemandoran'] ?? '') == $item->kemandoran ? 'selected' : '' }}>
                                    {{ $item->kemandoran }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="">
                        ...
                        <select name="panel_sadap"
                            class="px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 w-full">
                            <option value="">All Panel Sadap</option>
                            @foreach ($panelSadap as $item)
                                <option value="{{ $item->panel_sadap }}"
                                    {{ ($filters['panel_sadap'] ?? '') == $item->panel_sadap ? 'selected' : '' }}>
                                    {{ $item->panel_sadap }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="mt-2 flex gap-x-2">
                    <button type="submit"
                        class="px-3 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition duration-200">
                        Filter
                    </button>
                    ...
                    @if (
                        !empty($filters['dept']) ||
                            ...
                            !empty($filters['panel_sadap']) ||
                            !empty($filters['date_from']) ||
                            !empty($filters['date_to']))
                        <a href="{{ route('assessment-details.index') }}"
                            class="px-3 py-2 bg-gray-500 text-white rounded-md hover:bg-gray-600 transition duration-200">
                        ...
                        <div class="flex flex-wrap gap-2">
                            @if (!empty($filters['division']))
                                <span
                                    ...
                                    <a href="{{ route('assessment-details.index', array_merge($filters, ['division' => ''])) }}"
                            ...
                            @if (!empty($filters['dept']))
                                <span
                                    class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                    Dept: {{ $filters['dept'] }}
                                    <a href="{{ route('assessment-details.index', array_merge($filters, ['dept' => ''])) }}"
                                        class="ml-1 text-blue-600 hover:text-blue-800">
                                        <i class="ri-close-line text-sm"></i>
                                    </a>
                                </span>
                            ...
                            @if (!empty($filters['kemandoran']))
                                <span
                                    ...
                                    <a href="{{ route('assessment-details.index', array_merge($filters, ['kemandoran' => ''])) }}"
                                        class="ml-1 text-blue-600 hover:text-blue-800">
                                        <i class="ri-close-line text-sm"></i>
                                    </a>
                                </span>
                            ...
                            @if (!empty($filters['panel_sadap']))
                                <span
                                    ...
                                    <a href="{{ route('assessment-details.index', array_merge($filters, ['panel_sadap' => ''])) }}"
                                        class="ml-1 text-blue-600 hover:text-blue-800">
                                        <i class="ri-close-line text-sm"></i>
                                    </a>
                                </span>
                            ...
                            @if (!empty($filters['date_from']))
                                <span
                                    ...
                                    <a href="{{ route('assessment-details.index', array_merge($filters, ['date_from' => ''])) }}"
                                        class="ml-1 text-blue-600 hover:text-blue-800">
                                        <i class="ri-close-line text-sm"></i>
                                    </a>
                                </span>
                            ...
                            @if (!empty($filters['date_to']))
                                <span
                                    ...
                                    <a href="{{ route('assessment-details.index', array_merge($filters, ['date_to' => ''])) }}"
                                        class="ml-1 text-blue-600 hover:text-blue-800">
                                        <i class="ri-close-line text-sm"></i>
                                    </a>
                                </span>
            ...
            <table class="w-full text-xs">
                <thead>
                    <tr class="bg-blue-500 text-white border border-gray-200">
                        <th class="px-2 py-2 text-center border border-gray-200" rowspan="2">No</th>
                        <th class="px-2 py-2 text-center border border-gray-200" rowspan="2">Dept</th>
                        <th class="px-2 py-2 text-center border border-gray-200" rowspan="2">Kemandoran</th>
                        <th class="px-2 py-2 text-center border border-gray-200" rowspan="2">Panel Sadap</th>
                        <th class="px-2 py-2 text-center border border-gray-200" colspan="5">Kelas Perawan</th>
                        <th class="px-2 py-2 text-center border border-gray-200" colspan="5">Kelas Pulihan</th>
                        <th class="px-2 py-2 text-center border border-gray-200" colspan="5">Kelas NTA</th>
                        <th class="px-2 py-2 text-center border border-gray-200" rowspan="2">Total</th>
                    </tr>
                    <tr class="bg-blue-500 text-white">
                        <th class="px-2 py-2 text-center border border-gray-200"><span
                                data-tippy-content="Score <= 10.9">1</span></th>
                        <th class="px-2 py-2 text-center border border-gray-200"><span
                                data-tippy-content="10 < Score <= 20.9">2</span></th>
                        <th class="px-2 py-2 text-center border border-gray-200"><span
                                data-tippy-content="20 < Score <= 26.9">3</span></th>
                        <th class="px-2 py-2 text-center border border-gray-200"><span
                                data-tippy-content="26 < Score <= 32.9">4</span></th>
                        <th class="px-1 py-2 text-center border border-gray-200"><span
                                data-tippy-content="Score > 32">NC</span></th>
                        <th class="px-2 py-2 text-center border border-gray-200"><span
                                data-tippy-content="Score <= 15.9">1</span></th>
                        <th class="px-2 py-2 text-center border border-gray-200"><span
                                data-tippy-content="15 < Score <= 30.9">2</span></th>
                        <th class="px-2 py-2 text-center border border-gray-200"><span
                                data-tippy-content="30 < Score <= 38.9">3</span></th>
                        <th class="px-2 py-2 text-center border border-gray-200"><span
                                data-tippy-content="38 < Score <= 46.9">4</span></th>
                        <th class="px-1 py-2 text-center border border-gray-200"><span
                                data-tippy-content="Score > 46">NC</span></th>
                        <th class="px-2 py-2 text-center border border-gray-200"><span
                                data-tippy-content="Score <= 12.9">1</span></th>
                        <th class="px-2 py-2 text-center border border-gray-200"><span
                                data-tippy-content="12 < Score <= 25.9">2</span></th>
                        <th class="px-2 py-2 text-center border border-gray-200"><span
                                data-tippy-content="25 < Score <= 32.9">3</span></th>
                        <th class="px-2 py-2 text-center border border-gray-200"><span
                                data-tippy-content="32 < Score <= 39.9">4</span></th>
                        <th class="px-1 py-2 text-center border border-gray-200"><span
                                data-tippy-content="Score > 39">NC</span></th>
                    </tr>
                </thead>
                <tbody>
                    @forelse($summaryByKemandoranPanel as $key => $data)
                        <tr class="border-b border-gray-200 hover:bg-gray-50">
                            <td class="px-2 py-2 text-center text-gray-900 border border-gray-200">
                                {{ $loop->iteration }}</td>
                            <td class="px-2 py-2 text-center text-gray-700 border border-gray-200">
                                {{ $data['dept'] ?? '-' }}</td>
                            <td class="px-2 py-2 text-gray-900 border border-gray-200">{{ $data['kemandoran'] }}</td>
                            <td class="px-2 py-2 text-center text-gray-700 border border-gray-200">
                                {{ $data['panel_sadap'] }}</td>
                            ...
                            <td class="px-2 py-2 text-center border border-gray-200">
                                @if (isset($data['perawan_1']) && $data['perawan_1'] > 0)
                                    <a href="{{ route('assessment-details.detail', ['kemandoran' => $data['kemandoran'], 'panel_sadap' => $data['panel_sadap'], 'kelas_type' => 'perawan', 'kelas_value' => '1', 'date_from' => $filters['date_from'] ?? '', 'date_to' => $filters['date_to'] ?? '']) }}"
                                        class="px-1 py-0.5 text-xs rounded-full bg-green-100 text-green-800 hover:bg-green-200 transition-colors cursor-pointer">
                                        {{ $data['perawan_1'] }}
                                    </a>
                                @else
                                    <span class="px-1 py-0.5 text-xs rounded-full bg-gray-100 text-gray-500">0</span>
                                @endif
                            </td>
                            <td class="px-2 py-2 text-center border border-gray-200">
                            ...
                            <td class="px-1 py-2 text-center border border-gray-200">
                                @if (isset($data['perawan_NC']) && $data['perawan_NC'] > 0)
                                    <a href="{{ route('assessment-details.detail', ['kemandoran' => $data['kemandoran'], 'panel_sadap' => $data['panel_sadap'], 'kelas_type' => 'perawan', 'kelas_value' => 'NC', 'date_from' => $filters['date_from'] ?? '', 'date_to' => $filters['date_to'] ?? '']) }}"
                                        class="px-1 py-0.5 text-xs rounded-full bg-red-100 text-red-800 hover:bg-red-200 transition-colors cursor-pointer">
                                        {{ $data['perawan_NC'] }}
                                    </a>
                                @else
                                    <span class="px-1 py-0.5 text-xs rounded-full bg-gray-100 text-gray-500">0</span>
                            ...
                            <td class="px-2 py-2 text-center border border-gray-200">
                                @if (isset($data['pulihan_1']) && $data['pulihan_1'] > 0)
                                    <a href="{{ route('assessment-details.detail', ['kemandoran' => $data['kemandoran'], 'panel_sadap' => $data['panel_sadap'], 'kelas_type' => 'pulihan', 'kelas_value' => '1', 'date_from' => $filters['date_from'] ?? '', 'date_to' => $filters['date_to'] ?? '']) }}"
                                        class="px-1 py-0.5 text-xs rounded-full bg-blue-100 text-blue-800 hover:bg-blue-200 transition-colors cursor-pointer">
                                        {{ $data['pulihan_1'] }}
                                    </a>
                                @else
                                    <span class="px-1 py-0.5 text-xs rounded-full bg-gray-100 text-gray-500">0</span>
                            ...
                            <td class="px-2 py-2 text-center border border-gray-200">
                                @if (isset($data['nta_1']) && $data['nta_1'] > 0)
                                    <a href="{{ route('assessment-details.detail', ['kemandoran' => $data['kemandoran'], 'panel_sadap' => $data['panel_sadap'], 'kelas_type' => 'nta', 'kelas_value' => '1', 'date_from' => $filters['date_from'] ?? '', 'date_to' => $filters['date_to'] ?? '']) }}"
                                        class="px-1 py-0.5 text-xs rounded-full bg-yellow-100 text-yellow-800 hover:bg-yellow-200 transition-colors cursor-pointer">
                                        {{ $data['nta_1'] }}
                                    </a>
                                @else
                                    <span class="px-1 py-0.5 text-xs rounded-full bg-gray-100 text-gray-500">0</span>
                            ...
                            <!-- Total -->
                            <td class="px-2 py-2 text-center bg-blue-50 border border-gray-200">
                    ...
                    @empty
                        <tr>
                            <td colspan="20" class="px-2 py-8 text-center text-gray-500">
                ...
                @if (count($summaryByKemandoranPanel) > 0 &&
                        (!empty($filters['dept']) || !empty($filters['kemandoran']) || !empty($filters['panel_sadap'])))
                    @php
                        $totals = [
                    ...
                    <tfoot>
                        <tr class="bg-gray-100 font-semibold">
                            ...
                            <td class="px-4 py-3 text-center border border-gray-200">{{ $totals['perawan']['1'] }}
                            </td>
                            <td class="px-4 py-3 text-center border border-gray-200">{{ $totals['perawan']['2'] }}
                            </td>
                            <td class="px-4 py-3 text-center border border-gray-200">{{ $totals['perawan']['3'] }}
                            </td>
                            <td class="px-4 py-3 text-center border border-gray-200">{{ $totals['perawan']['4'] }}
                            </td>
                            <td class="px-2 py-3 text-center border border-gray-200">{{ $totals['perawan']['NC'] }}
                            </td>

                            <!-- Kelas Pulihan Totals -->
                            <td class="px-4 py-3 text-center border border-gray-200">{{ $totals['pulihan']['1'] }}
                            </td>
                            <td class="px-4 py-3 text-center border border-gray-200">{{ $totals['pulihan']['2'] }}
                            </td>
                            <td class="px-4 py-3 text-center border border-gray-200">{{ $totals['pulihan']['3'] }}
                            </td>
                            <td class="px-4 py-3 text-center border border-gray-200">{{ $totals['pulihan']['4'] }}
                            </td>
                            <td class="px-2 py-3 text-center border border-gray-200">{{ $totals['pulihan']['NC'] }}
                            </td>
